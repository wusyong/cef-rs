...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _cef_accelerated_paint_native_pixmap_plane_info_t"]
        [::std::mem::size_of::<_cef_accelerated_paint_native_pixmap_plane_info_t>() - 32usize];
    ["Alignment of _cef_accelerated_paint_native_pixmap_plane_info_t"]
        [::std::mem::align_of::<_cef_accelerated_paint_native_pixmap_plane_info_t>() - 8usize];
    ["Offset of field: _cef_accelerated_paint_native_pixmap_plane_info_t::stride"][::std::mem::offset_of!(
        _cef_accelerated_paint_native_pixmap_plane_info_t,
        stride
    ) - 0usize];
    ["Offset of field: _cef_accelerated_paint_native_pixmap_plane_info_t::offset"][::std::mem::offset_of!(
        _cef_accelerated_paint_native_pixmap_plane_info_t,
        offset
    ) - 8usize];
    ["Offset of field: _cef_accelerated_paint_native_pixmap_plane_info_t::size"]
        [::std::mem::offset_of!(_cef_accelerated_paint_native_pixmap_plane_info_t, size) - 16usize];
    ["Offset of field: _cef_accelerated_paint_native_pixmap_plane_info_t::fd"]
        [::std::mem::offset_of!(_cef_accelerated_paint_native_pixmap_plane_info_t, fd) - 24usize];
};
#[doc = "\n Structure containing the plane information of the shared texture.\n Sync with native_pixmap_handle.h\n"]
...
const _: () = {
    ["Size of _cef_accelerated_paint_info_t"]
        [::std::mem::size_of::<_cef_accelerated_paint_info_t>() - 152usize];
    ["Alignment of _cef_accelerated_paint_info_t"]
        [::std::mem::align_of::<_cef_accelerated_paint_info_t>() - 8usize];
    ["Offset of field: _cef_accelerated_paint_info_t::planes"]
        [::std::mem::offset_of!(_cef_accelerated_paint_info_t, planes) - 0usize];
    ["Offset of field: _cef_accelerated_paint_info_t::plane_count"]
        [::std::mem::offset_of!(_cef_accelerated_paint_info_t, plane_count) - 128usize];
    ["Offset of field: _cef_accelerated_paint_info_t::modifier"]
        [::std::mem::offset_of!(_cef_accelerated_paint_info_t, modifier) - 136usize];
    ["Offset of field: _cef_accelerated_paint_info_t::format"]
        [::std::mem::offset_of!(_cef_accelerated_paint_info_t, format) - 144usize];
};
#[doc = "\n Structure containing shared texture information for the OnAcceleratedPaint\n callback. Resources will be released to the underlying pool for reuse when\n the callback returns from client code.\n"]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _cef_popup_features_t"][::std::mem::size_of::<_cef_popup_features_t>() - 36usize];
    ...
    ["Offset of field: _cef_popup_features_t::isPopup"]
        [::std::mem::offset_of!(_cef_popup_features_t, isPopup) - 32usize];
};
#[doc = "\n Popup window features.\n"]
...
const _: () = {
    ...
    ["Offset of field: _cef_pdf_print_settings_t::landscape"]
        [::std::mem::offset_of!(_cef_pdf_print_settings_t, landscape) - 0usize];
    ["Offset of field: _cef_pdf_print_settings_t::print_background"]
        [::std::mem::offset_of!(_cef_pdf_print_settings_t, print_background) - 4usize];
    ["Offset of field: _cef_pdf_print_settings_t::scale"]
        [::std::mem::offset_of!(_cef_pdf_print_settings_t, scale) - 8usize];
    ["Offset of field: _cef_pdf_print_settings_t::paper_width"]
        [::std::mem::offset_of!(_cef_pdf_print_settings_t, paper_width) - 16usize];
    ["Offset of field: _cef_pdf_print_settings_t::paper_height"]
        [::std::mem::offset_of!(_cef_pdf_print_settings_t, paper_height) - 24usize];
    ["Offset of field: _cef_pdf_print_settings_t::prefer_css_page_size"]
        [::std::mem::offset_of!(_cef_pdf_print_settings_t, prefer_css_page_size) - 32usize];
    ["Offset of field: _cef_pdf_print_settings_t::margin_type"]
        [::std::mem::offset_of!(_cef_pdf_print_settings_t, margin_type) - 36usize];
    ["Offset of field: _cef_pdf_print_settings_t::margin_top"]
        [::std::mem::offset_of!(_cef_pdf_print_settings_t, margin_top) - 40usize];
    ["Offset of field: _cef_pdf_print_settings_t::margin_right"]
        [::std::mem::offset_of!(_cef_pdf_print_settings_t, margin_right) - 48usize];
    ["Offset of field: _cef_pdf_print_settings_t::margin_bottom"]
        [::std::mem::offset_of!(_cef_pdf_print_settings_t, margin_bottom) - 56usize];
    ["Offset of field: _cef_pdf_print_settings_t::margin_left"]
        [::std::mem::offset_of!(_cef_pdf_print_settings_t, margin_left) - 64usize];
...
const _: () = {
    ["Size of _cef_touch_handle_state_t"]
        [::std::mem::size_of::<_cef_touch_handle_state_t>() - 36usize];
    ...
    ["Offset of field: _cef_touch_handle_state_t::touch_handle_id"]
        [::std::mem::offset_of!(_cef_touch_handle_state_t, touch_handle_id) - 0usize];
    ["Offset of field: _cef_touch_handle_state_t::flags"]
        [::std::mem::offset_of!(_cef_touch_handle_state_t, flags) - 4usize];
    ["Offset of field: _cef_touch_handle_state_t::enabled"]
        [::std::mem::offset_of!(_cef_touch_handle_state_t, enabled) - 8usize];
    ["Offset of field: _cef_touch_handle_state_t::orientation"]
        [::std::mem::offset_of!(_cef_touch_handle_state_t, orientation) - 12usize];
    ["Offset of field: _cef_touch_handle_state_t::mirror_vertical"]
        [::std::mem::offset_of!(_cef_touch_handle_state_t, mirror_vertical) - 16usize];
    ["Offset of field: _cef_touch_handle_state_t::mirror_horizontal"]
        [::std::mem::offset_of!(_cef_touch_handle_state_t, mirror_horizontal) - 20usize];
    ["Offset of field: _cef_touch_handle_state_t::origin"]
        [::std::mem::offset_of!(_cef_touch_handle_state_t, origin) - 24usize];
    ["Offset of field: _cef_touch_handle_state_t::alpha"]
        [::std::mem::offset_of!(_cef_touch_handle_state_t, alpha) - 32usize];
};
...
const _: () = {
    ...
    ["Offset of field: _cef_frame_t::get_v8context"]
        [::std::mem::offset_of!(_cef_frame_t, get_v8context) - 216usize];
